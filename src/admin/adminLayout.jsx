...
import RouterCumb from "../admin/components/RouterCumb"; // Optional: If you want breadcrumbs
import ProgressBar from "../admin/components/progressBar/ProgressBar"; // Optional: If you want a progress bar
    ...
    return (
        <Box className="flex w-full min-h-screen bg-gradient-to-br from-green-100 via-white to-green-200">
            ...
            <Sidebar
                ...
                className={`lg:fixed absolute top-0 left-0 z-30 w-64 h-full bg-white transition-transform duration-300 ease-in-out ${openSidebar ? "translate-x-0" : "-translate-x-full"
                    }`}
            />
